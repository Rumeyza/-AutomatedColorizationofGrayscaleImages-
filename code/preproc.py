...
tf.app.flags.DEFINE_string('train_labels_file', '', 'Labels file')
tf.app.flags.DEFINE_string('test_labels_file', '', 'Labels file')
...
class ImageCoder(object):
  ...
  def resample_jpeg(self, image_data):
  	return  self._sess.run(self._recoded, #self._decode_jpeg,
...
def _find_image_files(data_dir, labels_file):
  ...
  unique_labels = [l.strip().split(',') for l in tf.gfile.FastGFile(
  ...
  for path, label in unique_labels:
...
def main(unused_argv):
  ...
  _process_dataset('validation', FLAGS.validation_directory,
                   FLAGS.validation_shards, FLAGS.test_labels_file)
